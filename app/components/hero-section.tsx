  ...
  return (
    <section className="w-full max-w-6xl mx-auto py-16 text-center">
      <div className="relative">
        ...
        <div className="absolute top-20 right-20 w-6 h-6 bg-cyan-500/30 rounded-full blur-lg animate-float-delay"></div>
        <div className="absolute bottom-10 left-20 w-10 h-10 bg-pink-500/30 rounded-full blur-lg animate-float-slow"></div>
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            ...
            <div className="flex items-center gap-2 bg-white/5 backdrop-blur-sm rounded-full px-4 py-2 border border-white/10">
              ...
              <span className="text-sm">Save Hours of Watching</span>
            </div>
            <div className="flex items-center gap-2 bg-white/5 backdrop-blur-sm rounded-full px-4 py-2 border border-white/10">
