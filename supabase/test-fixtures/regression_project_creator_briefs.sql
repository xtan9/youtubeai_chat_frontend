...
select pg_catalog.set_config(
  'request.jwt.claims',
  '{"sub":"84000000-0000-4000-8000-000000000004","is_anonymous":false,"app_metadata":{"project_beta_access":"internal"}}',
  true
);
...
select pg_catalog.set_config(
  'request.jwt.claims',
  '{"sub":"85000000-0000-4000-8000-000000000005","is_anonymous":false,"app_metadata":{"project_beta_access":"internal"}}',
  true
);
...
select pg_catalog.set_config(
  'request.jwt.claims',
  '{"sub":"86000000-0000-4000-8000-000000000006","is_anonymous":false,"app_metadata":{"project_beta_access":"internal"}}',
  true
);
