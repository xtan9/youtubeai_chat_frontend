...
select pg_catalog.set_config(
  'request.jwt.claims',
  '{"sub":"94000000-0000-4000-8000-000000000004","is_anonymous":false,"app_metadata":{"project_beta_access":"internal"}}',
  true
);
...
select pg_catalog.set_config(
  'request.jwt.claims',
  '{"sub":"91000000-0000-4000-8000-000000000001","is_anonymous":false,"app_metadata":{"project_beta_access":"internal"}}',
  true
);
...
select pg_catalog.set_config(
  'request.jwt.claims',
  '{"sub":"92000000-0000-4000-8000-000000000002","is_anonymous":false,"app_metadata":{"project_beta_access":"internal"}}',
  true
);
