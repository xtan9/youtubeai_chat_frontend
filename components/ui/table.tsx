...
function TableFooter({ className, ...props }: React.ComponentProps<"tfoot">) {
  return (
    <tfoot
      ...
      className={cn(
        "bg-surface-sunken/50 border-t font-medium [&>tr]:last:border-b-0",
        className
      )}
      {...props}
    />
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "hover:bg-surface-sunken/50 data-[state=selected]:bg-surface-sunken border-b transition-colors",
        className
      )}
      {...props}
    />
