...
This post walks through the workflow we built YouTube AI Chat for: turning a multi-hour podcast into a 60-second scan, then expanding only the parts that earn your attention.
