...
select pg_catalog.set_config(
  'request.jwt.claims',
  '{"sub":"87000000-0000-4000-8000-000000000007","app_metadata":{"project_beta_access":"internal"}}',
  true
);
...
select pg_catalog.set_config(
  'request.jwt.claims',
  '{"sub":"88000000-0000-4000-8000-000000000008","app_metadata":{"project_beta_access":"internal"}}',
  true
);
