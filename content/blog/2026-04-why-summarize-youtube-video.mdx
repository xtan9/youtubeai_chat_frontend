...
- **Visual demonstrations.** Live coding, design walkthroughs, video tutorials that depend on what is on screen. The transcript captures roughly 30% of what a viewer sees.
