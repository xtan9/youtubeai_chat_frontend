...
function ResizablePanelGroup({
  ...
  // `<div data-group>` carries no orientation attribute.
  return (
...
function ResizableHandle({
  ...
  return (
    <ResizablePrimitive.Separator
      ...
      className={cn(
        // v4 Separator carries aria-orientation (no data-orientation) — drive
        // direction-aware styling off the aria attribute.
